    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('about') ? 'is-invalid' : '' }}" name="about" id="about">{!! old('about', $vendor->about) !!}</textarea>
                @if($errors->has('about'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $vendor->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commision_annual_price') ? 'is-invalid' : '' }}" type="number" name="commision_annual_price" id="commision_annual_price" value="{{ old('commision_annual_price', $vendor->commision_annual_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('renew_commision_date') ? 'is-invalid' : '' }}" type="text" name="renew_commision_date" id="renew_commision_date" value="{{ old('renew_commision_date', $vendor->renew_commision_date) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Vendor::COMMISION_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('commision_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="commision_type_{{ $key }}" name="commision_type" value="{{ $key }}" {{ old('commision_type', $vendor->commision_type) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_knet_supported') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_knet_supported" id="is_knet_supported" value="1" {{ $vendor->is_knet_supported || old('is_knet_supported', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_cc_supported') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_cc_supported" id="is_cc_supported" value="1" {{ $vendor->is_cc_supported || old('is_cc_supported', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_charge') ? 'is-invalid' : '' }}" type="number" name="minimum_charge" id="minimum_charge" value="{{ old('minimum_charge', $vendor->minimum_charge) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('extra_info') ? 'is-invalid' : '' }}" name="extra_info" id="extra_info">{!! old('extra_info', $vendor->extra_info) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $vendor->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $vendor->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $vendor->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin') ? 'is-invalid' : '' }}" type="text" name="linkedin" id="linkedin" value="{{ old('linkedin', $vendor->linkedin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube') ? 'is-invalid' : '' }}" type="text" name="youtube" id="youtube" value="{{ old('youtube', $vendor->youtube) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pinterest') ? 'is-invalid' : '' }}" type="text" name="pinterest" id="pinterest" value="{{ old('pinterest', $vendor->pinterest) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('openning') ? 'is-invalid' : '' }}" type="text" name="openning" id="openning" value="{{ old('openning', $vendor->openning) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('closing') ? 'is-invalid' : '' }}" type="text" name="closing" id="closing" value="{{ old('closing', $vendor->closing) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_1') ? 'is-invalid' : '' }}" type="text" name="phone_1" id="phone_1" value="{{ old('phone_1', $vendor->phone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $vendor->phone_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_3') ? 'is-invalid' : '' }}" type="text" name="phone_3" id="phone_3" value="{{ old('phone_3', $vendor->phone_3) }}">
