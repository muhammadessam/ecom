    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slider_url') ? 'is-invalid' : '' }}" type="text" name="slider_url" id="slider_url" value="{{ old('slider_url', $slider->slider_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('views') ? 'is-invalid' : '' }}" type="number" name="views" id="views" value="{{ old('views', $slider->views) }}" step="1">
                @if($errors->has('views'))
