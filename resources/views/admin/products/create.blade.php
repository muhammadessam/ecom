    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_after_discount') ? 'is-invalid' : '' }}" type="number" name="price_after_discount" id="price_after_discount" value="{{ old('price_after_discount', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('discountable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="discountable" id="discountable" value="1" {{ old('discountable', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inventory_number') ? 'is-invalid' : '' }}" type="text" name="inventory_number" id="inventory_number" value="{{ old('inventory_number', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vendor') ? 'is-invalid' : '' }}" name="vendor_id" id="vendor_id" required>
                    @foreach($vendors as $id => $vendor)
                        <option value="{{ $id }}" {{ old('vendor_id') == $id ? 'selected' : '' }}>{{ $vendor }}</option>
                    @endforeach
                </select>
