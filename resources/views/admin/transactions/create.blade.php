    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postdate') ? 'is-invalid' : '' }}" type="text" name="postdate" id="postdate" value="{{ old('postdate', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tranid') ? 'is-invalid' : '' }}" type="text" name="tranid" id="tranid" value="{{ old('tranid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auth') ? 'is-invalid' : '' }}" type="text" name="auth" id="auth" value="{{ old('auth', '') }}">
                @if($errors->has('auth'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trackid') ? 'is-invalid' : '' }}" type="text" name="trackid" id="trackid" value="{{ old('trackid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('udf_1') ? 'is-invalid' : '' }}" type="text" name="udf_1" id="udf_1" value="{{ old('udf_1', '') }}">
                @if($errors->has('udf_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('udf_2') ? 'is-invalid' : '' }}" type="text" name="udf_2" id="udf_2" value="{{ old('udf_2', '') }}">
                @if($errors->has('udf_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('udf_3') ? 'is-invalid' : '' }}" type="text" name="udf_3" id="udf_3" value="{{ old('udf_3', '') }}">
                @if($errors->has('udf_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('udf_4') ? 'is-invalid' : '' }}" type="text" name="udf_4" id="udf_4" value="{{ old('udf_4', '') }}">
                @if($errors->has('udf_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('udf_5') ? 'is-invalid' : '' }}" type="text" name="udf_5" id="udf_5" value="{{ old('udf_5', '') }}">
                @if($errors->has('udf_5'))
