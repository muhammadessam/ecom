    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('adress') ? 'is-invalid' : '' }}" name="adress_id" id="adress_id" required>
                    @foreach($adresses as $id => $adress)
                        <option value="{{ $id }}" {{ old('adress_id') == $id ? 'selected' : '' }}>{{ $adress }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('picked_at') ? 'is-invalid' : '' }}" type="text" name="picked_at" id="picked_at" value="{{ old('picked_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('delievered_at') ? 'is-invalid' : '' }}" type="text" name="delievered_at" id="delievered_at" value="{{ old('delievered_at') }}">
