    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('store_name') ? 'is-invalid' : '' }}" type="text" name="store_name" id="store_name" value="{{ old('store_name', $setting->store_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('store_title') ? 'is-invalid' : '' }}" type="text" name="store_title" id="store_title" value="{{ old('store_title', $setting->store_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('e_mail') ? 'is-invalid' : '' }}" type="email" name="e_mail" id="e_mail" value="{{ old('e_mail', $setting->e_mail) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receive_order_email') ? 'is-invalid' : '' }}" type="email" name="receive_order_email" id="receive_order_email" value="{{ old('receive_order_email', $setting->receive_order_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="number" name="telephone" id="telephone" value="{{ old('telephone', $setting->telephone) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="number" name="mobile" id="mobile" value="{{ old('mobile', $setting->mobile) }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\Setting::CLOSE_ORDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('close_order') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="close_order_{{ $key }}" name="close_order" value="{{ $key }}" {{ old('close_order', $setting->close_order) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ios_app_link') ? 'is-invalid' : '' }}" type="text" name="ios_app_link" id="ios_app_link" value="{{ old('ios_app_link', $setting->ios_app_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('android_app_link') ? 'is-invalid' : '' }}" type="text" name="android_app_link" id="android_app_link" value="{{ old('android_app_link', $setting->android_app_link) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Setting::UPDATEIOS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('updateios') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="updateios_{{ $key }}" name="updateios" value="{{ $key }}" {{ old('updateios', $setting->updateios) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Setting::UPDATEANDROID_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('updateandroid') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="updateandroid_{{ $key }}" name="updateandroid" value="{{ $key }}" {{ old('updateandroid', $setting->updateandroid) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iosupdatever') ? 'is-invalid' : '' }}" type="text" name="iosupdatever" id="iosupdatever" value="{{ old('iosupdatever', $setting->iosupdatever) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('androidupdatever') ? 'is-invalid' : '' }}" type="text" name="androidupdatever" id="androidupdatever" value="{{ old('androidupdatever', $setting->androidupdatever) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('general_image_path') ? 'is-invalid' : '' }}" type="text" name="general_image_path" id="general_image_path" value="{{ old('general_image_path', $setting->general_image_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_image_path') ? 'is-invalid' : '' }}" type="text" name="product_image_path" id="product_image_path" value="{{ old('product_image_path', $setting->product_image_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vendor_image_path') ? 'is-invalid' : '' }}" type="text" name="vendor_image_path" id="vendor_image_path" value="{{ old('vendor_image_path', $setting->vendor_image_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slide_image_path') ? 'is-invalid' : '' }}" type="text" name="slide_image_path" id="slide_image_path" value="{{ old('slide_image_path', $setting->slide_image_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_video_path') ? 'is-invalid' : '' }}" type="text" name="product_video_path" id="product_video_path" value="{{ old('product_video_path', $setting->product_video_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_image_path') ? 'is-invalid' : '' }}" type="text" name="category_image_path" id="category_image_path" value="{{ old('category_image_path', $setting->category_image_path) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_opening_time') ? 'is-invalid' : '' }}" type="text" name="start_opening_time" id="start_opening_time" value="{{ old('start_opening_time', $setting->start_opening_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('close_openning_time') ? 'is-invalid' : '' }}" type="text" name="close_openning_time" id="close_openning_time" value="{{ old('close_openning_time', $setting->close_openning_time) }}">
