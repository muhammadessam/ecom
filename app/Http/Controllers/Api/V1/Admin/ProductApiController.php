...
class ProductApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ProductResource(Product::with(['categories', 'tags', 'status', 'vendor', 'brand'])->get());
    }
    ...
    public function show(Product $product)
    {
        ...
        return new ProductResource($product->load(['categories', 'tags', 'status', 'vendor', 'brand']));
    }
